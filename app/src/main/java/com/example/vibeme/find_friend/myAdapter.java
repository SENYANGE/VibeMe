...
public class myAdapter extends RecyclerView.Adapter<myAdapter.myviewholder1> {
    ...
    private ArrayList<vibers> profiles;

    DatabaseReference reference;
    FirebaseAuth auth;


    public myAdapter(Context c, ArrayList<vibers> p) {
        this.context = c;
        this.profiles = p;
    }
    ...
    public void onBindViewHolder(@NonNull final myviewholder1 holder, final int position) {
       ...
       Picasso.get().load(profiles.get(position).getImage()).placeholder(R.drawable.profile).into(holder.circleImageView);
    ...
    static class myviewholder1 extends RecyclerView.ViewHolder
    {
     ...
     CircleImageView circleImageView;
        ...
        public myviewholder1(@NonNull View itemView) {
            super(itemView);
            circleImageView=itemView.findViewById(R.id.rect);
