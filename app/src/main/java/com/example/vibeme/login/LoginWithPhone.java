    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(txt_phone.getText())){
                    Toast.makeText(LoginWithPhone.this, "Enter your phone num", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    PhoneAuthProvider.getInstance().verifyPhoneNumber(
                            ...
                            LoginWithPhone.this,               // Activity (for callback binding)
        ...
        verity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(code)){
                    Toast.makeText(LoginWithPhone.this, "Enter code", Toast.LENGTH_SHORT).show();
                }
                else{
        ...
        mCallbacks=new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(@NonNull FirebaseException e) {
                ...
                Toast.makeText(LoginWithPhone.this, "Invalid num", Toast.LENGTH_SHORT).show();
