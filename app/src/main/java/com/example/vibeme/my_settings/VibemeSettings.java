package com.example.vibeme.my_settings;
...
public class VibemeSettings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vibeme_settings);
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE)
        {
            ...
            /**    filePath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task)
                    {
                        ...
                        {
                            Toast.makeText(VibemeSettings.this, "Profile Image uploaded Successfully...", Toast.LENGTH_SHORT).show();
                            ...
                            reference.child("Users").child(currentuserid).child("image")
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task)
                                        {
                                            if (task.isSuccessful())
                                            {
                                                Toast.makeText(VibemeSettings.this, "Image save in Database, Successfully...", Toast.LENGTH_SHORT).show();

                                            }
                                            else
                                            {
                                                String message = task.getException().toString();
                                                Toast.makeText(VibemeSettings.this, "Error: " + message, Toast.LENGTH_SHORT).show();
...
**/
    ...
    private void updateyourinfo(){
        ...
        if(TextUtils.isEmpty(name)){
            ...
            reference.child("Users").child(currentuserid).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if(task.isSuccessful()){
                        Toast.makeText(VibemeSettings.this, "Successfull", Toast.LENGTH_SHORT).show();
                        sendusertoMain();
                    }
                    else{
                        String message=task.getException().toString();
    ...
    private void sendusertoMain() {
        Intent mainIntent = new Intent(VibemeSettings.this, MainActivity.class);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot)
                    {
                        ...
                        else
                        {
                            ...
                            Toast.makeText(VibemeSettings.this, "Please set & update your profile information...", Toast.LENGTH_SHORT).show();
                        }
                    }
