package com.example.vibeme.request_frag;
...
public class Request extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        UsersRef = FirebaseDatabase.getInstance().getReference().child("vibeme").child("Users");
        ChatRequestsRef = FirebaseDatabase.getInstance().getReference().child("vibeme").child("Chat Requests");
        ContactsRef = FirebaseDatabase.getInstance().getReference().child("vibeme").child("Contacts");
    ...
    public void onStart()
    {
        ...
        FirebaseRecyclerOptions<vibers> options =
                new FirebaseRecyclerOptions.Builder<vibers>()
                        .setQuery(ChatRequestsRef.child(currentUserID), vibers.class)
                        .build();


        FirebaseRecyclerAdapter<vibers, RequestsViewHolder> adapter =
                new FirebaseRecyclerAdapter<vibers, RequestsViewHolder>(options) {
                    @Override
                    protected void onBindViewHolder(@NonNull final RequestsViewHolder holder, int position, @NonNull vibers model)
                    {
